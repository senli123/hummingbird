#include "yolov5Preprocess_wrapper.h" 
namespace Engine
{
REGISTER_PREPROCESS(Yolov5PreprocessWrapper)
bool Yolov5PreprocessWrapper::Init(MapCalcParam& preprocess_input)
{
     
    return true;
    
}
bool Yolov5PreprocessWrapper::Run(cv::Mat& input_mat)
{
    int input_h = 640;  
    int input_w = 640;
